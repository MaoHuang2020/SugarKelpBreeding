...
### 1. 
CalGCA_noChk<-function(Y=Y,mm.file=mm.file,colIDy=3,colNam="P1",savefiledir="Onetime1920/Yr19_20/GP1/"){
...
yHatVarMean_noloc<-function(filedir,vB=2,vGCA1=3,vGCA2=4,vSCA=5,filename="Model_noFMLoc"){
  ...
  #### Save the plot!!!!!
  pdf(paste0(WD,filedir,"varE_varGCA1_2_SCA_noLoc_test.pdf"))
  par(mfrow=c(2,2))
  ...
  varMean<-rbind(varMean,varfm)
    write.csv(varMean,paste0(WD,filedir,"varMean_noLoc.csv"))
