...
for (j in 1:length(traits)){
  ...
  Y<-Y1  # Now Y is updated with its BLUEs from within 2019 and 2020 WithinYr
...
# write.csv(colMeans(cor),paste0(paste0("cor_CV_OnlyYr",Yr,"_ydrBLUPs_data_",length(traits),"Traits_Mean.csv")))
# write.csv(cor,paste0("cor_CV_OnlyYr",Yr,"_ydrBLUPs_data_",length(traits),"Traits.csv"))
