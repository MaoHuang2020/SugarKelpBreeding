...
# }
# save(sampleCV,file=paste0(WD,"OneTime1920/data/sampleCV_Yr",Yr,"_122Indiv_0423_2021.Rdata"))
# ###### One Time
...
### Load Sample file
load(paste0(WD,"OneTime1920/data/sampleCV_Yr",Yr,"_122Indiv_0423_2021.Rdata"))
...
write.csv(colMeans(cor),paste0(paste0("cor_CV_OnlyYr",Yr,"_ydrBLUPs_data_",length(traits),"_rep_3to10_Traits_Mean.csv")))
write.csv(cor,paste0("cor_CV_OnlyYr",Yr,"_ydrBLUPs_data_",length(traits),"_rep_3to10_Traits.csv"))


#write.csv(colMeans(cor),paste0(paste0("cor_CV_OnlyYr",Yr,"_ydrBLUPs_data_AddBD_Traits_Mean.csv")))
#write.csv(cor,paste0("cor_CV_OnlyYr",Yr,"_ydrBLUPs_data_AddBD_Traits.csv"))
