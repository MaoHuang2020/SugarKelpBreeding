...
for (i in 1:20){
  ...
  savepath<-paste0("OneTime1920/Yr19to20_output/withFMLocRep",i,"/")  # the path following WD
...
for (i in 1:20){
  savepath<-paste0("OneTime1920/Yr19to20_output/withFMLocRep",i,"/")
...
write.csv(r2, paste0(WD,savepath,"cor_",i,"Reps.csv"))
print(mean(r2)) #-0.1159702
