...
CrossBLUE$BLUE_DwPM_2019_2<-expss::vlookup(CrossBLUE$CrossName,dict=CrossBLUE2[[1]],result_column = "BLUE_DwPM_1Year",lookup_column = "CrossName")
CrossBLUE$BLUE_DwPM_2020_2<-expss::vlookup(CrossBLUE$CrossName,dict=CrossBLUE2[[2]],result_column = "BLUE_DwPM_1Year",lookup_column = "CrossName")
