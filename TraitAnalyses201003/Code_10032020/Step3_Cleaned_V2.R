...
biphasicPedNH<-read.csv(here("ReorderPedigree","Ped_in_Order_866_Individuals_Fndr_New_Order_0116_2021.csv"),sep=",",header=TRUE,row.names=1)
  biphasicPedNH[1:4,]
...
# #Hap
# load(here("Making_haploid_CovComb","hMat_hap_0116_2021.Rdata"))
#   outCovComb<-hMat_hap
